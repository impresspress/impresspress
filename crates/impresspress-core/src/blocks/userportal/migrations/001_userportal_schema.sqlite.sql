...
-- `impresspress__userportal__buttons` (TEXT-only columns, no indexes) with
...
CREATE TABLE IF NOT EXISTS impresspress__userportal__buttons (
    id          TEXT PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS impresspress__userportal__buttons_sort_order_idx
    ON impresspress__userportal__buttons (sort_order);
