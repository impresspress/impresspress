...
CREATE TABLE IF NOT EXISTS wafer_run__auth__api_keys (
    id             TEXT PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS wafer_run__auth__api_keys_user_id_idx
    ON wafer_run__auth__api_keys (user_id);
